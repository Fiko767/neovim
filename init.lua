...
-- For Copilot
map("n", "<leader>ac", ":CopilotChatToggle<CR>")
map("v", "<leader>ac", ":CopilotChatToggle<CR>")
map("n", "<leader>ae", ":CopilotChatExplain<CR>")
map("v", "<leader>ae", ":CopilotChatExplain<CR>")
map("n", "<leader>ar", ":CopilotChatReview<CR>")
map("v", "<leader>ar", ":CopilotChatReview<CR>")
map("n", "<leader>af", ":CopilotChatFix<CR>")
map("v", "<leader>af", ":CopilotChatFix<CR>")
map("n", "<leader>ao", ":CopilotChatOptimize<CR>")
map("v", "<leader>ao", ":CopilotChatOptimize<CR>")
map("n", "<leader>ad", ":CopilotChatDocs<CR>")
map("v", "<leader>ad", ":CopilotChatDocs<CR>")
map("n", "<leader>at", ":CopilotChatTests<CR>")
